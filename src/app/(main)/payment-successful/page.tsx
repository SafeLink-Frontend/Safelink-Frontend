      ...
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="text-center my-5">
          ...
          <p className="text-[10px] leading-[15px] my-3">
            Your payment in the amount of{" "}
            <span className="text-[#F2BE5C]">N18,000 </span> has successfully
            processed you can now enjoy our features
          </p>
        </div>
      </div>
      <div>
        <button className="bg-[#F2BE5C] rounded p-3 text-white leading-[18px] text-[12px] font-medium w-full my-3">
          Proceed to Listing
        </button>
      </div>
    </section>
